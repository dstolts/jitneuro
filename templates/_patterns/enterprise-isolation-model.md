...
- /learn (updates this repo's bundles, engrams; flags new routes for PR to <knowledge-root>/INDEX.md)
...
- Routing from <knowledge-root>/INDEX.md (shared across all users; extensions via PR)
