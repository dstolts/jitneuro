---
type: pattern
purpose: Defines a multi-persona review gate that evaluates AI-generated code or plans from several distinct expert perspectives (security, reliability, maintainability, UX) before acceptance; MUST be run as a pre-merge / pre-execution quality gate by any team relying on an AI assistant to produce code or designs, because single-perspective review systematically misses whole defect classes -- the issues no one reviewer was looking for ship to production unflagged.
