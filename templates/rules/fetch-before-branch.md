...
Origin incident (2026-05-12): a feature PR (submodule bump v1.0.2 -> v1.1) hit a merge
conflict on open because the local knowledge catalog submodule pin was read from the stale
