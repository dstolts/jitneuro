...
2026-05-20. Framework installer scripts, including JitNeuro `install.sh` /
...
This rule was moved from a machine-local `~/.claude/rules/` file into a
portable framework rule so installers and agents in any clone can reference
`rules/claude-code-hook-deployment.md`.
