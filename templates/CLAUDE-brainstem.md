...
- Shared catalog: internal/team catalog only when configured
...
| `<private-catalog>/INDEX.md` | Internal/team shared catalog only when configured; not required for public JitNeuro |
